...
//Realiza a convercao de um dos argumentos de string para inteiro para identificar a opcao.
 ...
 //passa o nome do arquivo de entrada da linha de comando para ser executado.
